...
if __name__ == '__main__':
    ...
    exec_full("./BK/news_a.py")
    exec_full("./BK/news_b.py")
    time.sleep(0.2)
    sys.stdout.write("Getting " + str(wkoso) + "...\n")
    exec_full("./KS/news_a.py")
    exec_full("./KS/news_b.py")
    time.sleep(0.2)
    sys.stdout.write("Getting " + str(wrsrb) + "...\n")
    exec_full("./RS/news_a.py")
    exec_full("./RS/news_b.py")
    time.sleep(0.2)
    time.sleep(1)
    sys.stdout.write("Converting...\n")
    exec_full("./BK/csv_convert_a.py")
    exec_full("./BK/csv_convert_b.py")
    time.sleep(1)
    exec_full("./KS/csv_convert_a.py")
    exec_full("./KS/csv_convert_b.py")
    time.sleep(1)
    exec_full("./RS/csv_convert_a.py")
    exec_full("./RS/csv_convert_b.py")
    time.sleep(1)
